...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_sidecar_test_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_sidecar_test_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:mik:sidecar-test@0.1.0:sidecar-test:encoded world"
)]
#[doc(hidden)]
...
\x04\0\x16mik:core/handler@0.1.0\x05\x13\x04\0#mik:sidecar-test/sidecar-test@0.1\
.0\x04\0\x0b\x12\x01\0\x0csidecar-test\x03\0\0\0G\x09producers\x01\x0cprocessed-\
