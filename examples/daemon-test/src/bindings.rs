...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:daemon-test:handler@0.2.0:handler:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7038] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x806\x01A\x02\x01A#\x01\
...
\x04\0!daemon-test:handler/handler@0.2.0\x04\0\x0b\x0d\x01\0\x07handler\x03\0\0\0\
